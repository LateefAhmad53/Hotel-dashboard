                        ...
                        <div class="card-body p-0">
                            <div class="row g-0">
                                <div class="col-lg-6 p-4">
                                    ...
                                    <form action="{{ url('/sigin') }}" method="POST" class="authentication-form">
                                        @csrf
                                ...
                                <div class="col-lg-6 d-none d-md-inline-block">
                                    <div class="auth-page-sidebar">
                                        ...
                                        <div class="auth-user-testimonial">
                                            <p class="fs-24 fw-bold text-white mb-1">Lincoln Height Hotel</p>
                                            <p class="lead">"Hotel Management System for Lincoln Height Hotel"</p>
                                            <p>- Admin User</p>
                                        </div>
                                    </div>
                                </div>
